CLASS lhc_zrap100_r_traveltp_582 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    CONSTANTS:
...
CLASS lhc_zrap100_r_traveltp_582 IMPLEMENTATION.
  METHOD get_global_authorizations.
  ENDMETHOD.
  METHOD earlynumbering_create.

    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_582,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_dtrav582 FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_582 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_582 IN LOCAL MODE
      ENTITY Travel
...
*    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_582.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_582\\travel.
