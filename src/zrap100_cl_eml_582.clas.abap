CLASS zrap100_cl_eml_582 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_cl_eml_582 IMPLEMENTATION.
...
*        FIELDS ( AgencyID CustomerID BeginDate Description )
  ...
  METHOD update_travel.
    ...
    COMMIT ENTITIES
      RESPONSE OF ZRAP100_R_TravelTP_582
