CLASS zcl_rap100_gen_data_582 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_582 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '582',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav582.
*    DELETE FROM zrap100_dtrav582.

    "insert travel demo data
    INSERT zrap100_atrav582  FROM (
        SELECT
